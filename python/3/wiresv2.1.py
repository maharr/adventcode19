...
for points1 in path[0]:
    for points2 in path[1]:
        if points1[0] == points2[0] and points1[1] == points2[1]:
            p = [int(points1[2])+ int(points2[2]), abs(points1[0])+abs(points1[1])]
            pairs.append(p)
            #print(int(points1[2])+ int(points2[2]))
